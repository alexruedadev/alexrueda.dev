...
<div class="hide">I am shown when someone hovers over the div above.</div>
    ...
    <div class="max-w-5xl mx-auto">
        <h2 class="pl-3 font-pixel_boy text-lg">Developer Junior</h2>
        <!-- exp -->
        <div id="exp-menu" class="grid-cols-3">
            <!-- character + empty -->
        ...
        <div class="h-7 bg-gray-200 rounded-sm dark:bg-gray-700 w-full">
            ...
            <p class="text-gray-300 text-xl px-2 py-1 rounded-sm font-pixel_boy">Best skills</p>

        <!-- skills -->
        <div class="grid sm:grid-cols-2 sm:mx-auto bg-gray-100 dark:bg-gray-800 shadow-md overflow-hidden">
            ...
            <dt class=" font-pixel_boy text-lg text-gray-400 inline-flex flex-1">
                ...
                <p class="mt-1">{{ item.name }}</p>
                 ...
                 <dt class="text-sm font-medium text-gray-400 text-right lg:mt-1">
                    <!-- <p class="hidden sm:inline-block font-pixel_boy text-lg">Total XP</p> -->
                    <div class="mt-1 ml-1 inline-flex items-baseline px-2.5 rounded-sm font-medium leading-5 bg-gray-800 text-green-400 lg:mt-0 font-pixel_boy text-xl">
        ...
        <h2 class="px-2 py-1 font-pixel_boy text-xl text-gray-300">Equipement</h2>
            ...
            <dl>
                ...
                <dd class="mt-1 text-gray-400 sm:mt-0 sm:col-span-2">
                    {{ item.value }}
                </dd>
                </div>
            </dl>
