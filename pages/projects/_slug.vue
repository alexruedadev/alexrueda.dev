...
<div class="max-w-7xl mx-auto border-gray-700 border-l border-r">
      ...
      <article data-aos="fade-up">
        <div class="space-y-9">
          ...
          <div class="px-4 sm:px-0 lg:px-4 pb-4 bg-gray-900 rounded-lg">
            ...
            <div id="project-body" class="break-words my-4 prose-sm max-w-4xl mx-auto">
        ...
        <div v-if="$config.firebase.enabled">
          ...
          <div id="comments" class="border-t-2 border-gray-700 mt-6 py-5">
  ...
  <div @click="scrollToTop" class="cursor-pointer fixed z-50 bottom-4 right-4 w-8 rounded-full bg-gray-900 text-white block hover:text-hot-pink">
