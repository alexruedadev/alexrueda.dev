<template>
  <footer>
    <div id="liner" class="max-w-7xl border-l border-r border-dashed mx-auto px-4">
      <div class="pt-5 pb-12 md:flex md:justify-between">
        ...
        <p class="mt-8 text-sm leading-6 text-gray-400 md:mt-0 md:order-1 text-center">
           &lt;/&gt; by <span class="ceator-preview hover:text-hot-pink text-gray-300">
          <a class="inline-block" target="_blank" :href="`https://github.com/${$config.social.github}`"><p>{{ $config.name }}</p></a>
          </span>
        </p>
      </div>
    </div>
