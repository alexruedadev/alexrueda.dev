...
<div class="relative">
    ...
    <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
        ...
        <div id="carousel-item-1" class="hidden duration-700 ease-in-out">
            ...
            <img src="/images/pixelart/javascript.png" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        ...
        <div id="carousel-item-4" class="hidden duration-700 ease-in-out">
            <img src="/images/pixelart/python.png" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
        </div>
    </div>
    <!-- Slider indicators -->
...
import Carousel from '/node_modules/flowbite/src/components/carousel.js'
