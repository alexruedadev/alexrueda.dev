<template>
  <div id="liner" class="max-w-7xl mx-auto mt-10 grid grid-cols-3">
    <!-- liner -->
    <div class="grid-rows-2 flex-col ml-10">
        <div id="liner" class="h-7 border-b border-1 border-dashed">
...
<!--         <img src="images/frameworks-pixel.png" class="w-12 h-12 p-2 m-1 hover:bg-gray-700 rounded-sm" alt="">
    ...
    <!-- liner -->
    <div class="grid-rows-2 flex-col mr-10">
        <div id="liner" class="h-7 border-b border-1 border-dashed">
