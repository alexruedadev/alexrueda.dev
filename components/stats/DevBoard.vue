    ...
    <div id="liner" class="max-w-7xl mx-auto sm:p-10 p-5 font-playmegames">
        <div class="max-w-5xl mx-auto">
            <!-- 
                exp menu 
            -->
            <div data-aos="zoom-in" id="exp-menu" class="mb-10">
                ...
                <div class="h-7 bg-gray-200 dark:bg-gray-700 w-full relative text-center text-md text-gray-100">
                    <div id="progress-bar" class="h-7" :style="{width: levelProgress + '%'}"></div>
...
<!-- 
            <div class="flex overflow-x-auto space-x-80 w-5xl no-scrollbar">
                <div v-for="(item, index, n) in $config.fullstack.languages" class="mr-2">
                      <img :src="item.img" class="w-10 mx-5 hover:scale-125" alt="">
...
<div id="default-carousel" class="relative" data-carousel="static">
    ...
    <div class="overflow-hidden relative h-56 rounded-lg md:h-96">
        ...
        <div class="duration-700 ease-in-out" data-carousel-item>
            ...
            <img src="/images/pixelart/javascript.png" class="block2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="/images/pixelart/html.png" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
        </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="/images/pixelart/css3.png" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
        </div>
    </div>
    <!-- Slider indicators -->
