      ...
      <div class="flex-1 bg-gray-900 p-5 flex flex-row justify-between">
        <div class="flex-1 flex flex-col justify-between">
          ...
          <div class="flex mt-2 space-x-2 flex-row">
            <a target="_blank" rel="noreferrer" :href="project.website" class="hover:text-blue-light text-gray-600">
            ...
            <a target="_blank" rel="noreferrer" :href="project.github" class="hover:text-blue-light text-gray-600">
