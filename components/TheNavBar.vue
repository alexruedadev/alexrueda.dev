...
<nav class="backdrop-filter backdrop-blur sticky top-0 z-40 w-full">
  <div id="liner" class="max-w-5xl mx-auto px-2 sm:px-4 lg:px-8">
      ...
      <div class="rounded-lg ">
        <div class="bg-gray-200 dark:bg-gray-900 rounded-lg overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
          ...
          <div @click="mobileMenuOpen = false" class="flex flex-col space-y-1 px-2 pt-2 pb-3">
            ...
            <nuxt-link v-show="$config.devboard.enabled" :to="localePath('/devboard')" class="flex px-3 py-2 rounded-md text-base font-medium focus:outline-none text-gray-900 dark:text-gray-200 focus:text-gray-100 focus:bg-gray-500 transition duration-150 ease-in-out" role="menuitem">{{ $t('nav.devboard')}}</nuxt-link>
